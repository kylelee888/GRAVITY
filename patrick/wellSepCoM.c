...
int wellSepCoM(int currPlanet, int tempReg, vector COM[])
{
	int l = region[tempReg].level;
	vector tempCoM=COM[arrayIndex(l,tempReg)];
	...
	vector sep = BD[currPlanet].pos - tempCoM;
