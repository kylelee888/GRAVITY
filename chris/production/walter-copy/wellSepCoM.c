...
int wellSepCoM(planet currPlanet, region tempReg)
{
	...
	alpha2 = 10000000000;//This factor determines "how many beta's" a region's center of mass needs to be from the planet we're concerned with in order to be considered well-separated. In this case, > 2 betas is well separated.
