...
double wellSepCoM(planet& currPlanet, region& tempReg)
{
	...
	beta2 = beta*beta;//Use beta^2 for cheaper math
        // WF -- alpha2 changed to global so we can mess iwth it
	//alpha = 2; alpha2 = alpha*alpha;
	//alpha2 = 2;//This factor determines "how many beta's" a region's center of mass needs to be from the planet we're concerned with in order to be considered well-separated. In this case, > 2 betas is well separated.
